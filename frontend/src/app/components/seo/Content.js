  ...
  return (
    <div className=" ">
      ...
      <h3 className="bungeeHead  text-[#cc5f4d]  text-[30px] xl:text-[40px]">What Makes SEO Vital?</h3>
        ...
        In the modern era of digital world, search engine optimization (SEO) is essential for making sure search engines can quickly find your website.
        </p>
      </div>
      ...
      <div className=" text-center mx-4 md:mx-12 lg:mx-32 xl:mx-72 my-12">
        ...
        <img src="/Images/addOn/LG.webp" alt="" className="zoom w-full h-auto object-cover"/>
            ...
            <div className="">
              <h3 className="bungeeHead p-4 text-md text-[#2e2d2d]">A rise in traffic
              </h3>
            </div>
...
servicePara text-gray-500 text-sm">
        ...
        <div className="text-center mt-12">
          <button className="px-6 py-2 border-2 rounded-xl border-black bg-[#cc5f4d] hover:bg-[#006E7F] text-white font-medium text-base underline ">
            Contact Us
          </button>
        </div>
