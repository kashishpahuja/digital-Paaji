  ...
  return (
    <div className="flex flex-col xl:flex-row items-stretch  mx-8 md:mx-12 xl:mx-72">
      ...
      <div className="z-[999] w-full xl:w-1/2 p-6 md:p-8  xl:p-12 bg-[#cc5f4d] ">
        ...
        <div className="">
          <Link  href="tel:+918699640752" className="px-6 py-2 border rounded-xl border-black bg-[#f8cb2e] hover:bg-[#cc5f4d] text-black hover:text-white font-medium text-lg ">
            Contact Us
          </Link>
        </div>
      </div>
