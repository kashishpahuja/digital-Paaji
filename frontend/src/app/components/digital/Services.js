    ...
    <div className=" ">
      ...
      <div className=" text-center mx-4 md:mx-12 lg:mx-32 xl:mx-72 my-24">
        ...
        <img src="/Images/addOn/LG.webp" alt="" className="zoom w-full h-auto object-cover"/>
            ...
            <div className="my-2">
              <h3 className="bungeeHead p-4 text-md lg:text-xl text-[#2e2d2d]">Tailored Strategies:
              </h3>
            </div>
        ...
        <img src="/Images/addOn/LG.webp" alt="" className="zoom w-full h-auto object-cover"/>
            ...
            <div className="my-2">
              <h3 className="bungeeHead p-4 text-md lg:text-xl text-[#2e2d2d]">Music Video Editing 
              </h3>
            </div>
            <div className="text-center">
          <p className="merriHead text-sm text-gray-500">
