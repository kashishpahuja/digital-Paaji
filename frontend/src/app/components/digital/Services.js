    ...
    <div className=" ">
      <div className="text-center mt-24 mx-8 md:mx-12 lg:mx-32 xl:mx-72">
        ...
        <p className="servicePara text-[#252424] mt-4 text-sm  ">
          ...
          to delivering outcomes and assisting companies in navigating the
          tricky world of internet marketing. Your internet appearance will be
          transformed, and your business goals will be met.
        </p>
      </div>
