    ...
    <div className=" ">
        ...
        height={200}
              ...
              <div className="text-justify">
                <p className="merriHead text-gray-500 text-xs">
                  ...
                  music video. To make sure the graphics complement the mood of
                  the song, we examine the tone, rhythm, and mood of the music.
                  For depth and individuality, we also use slow motion and
                  dynamic effects. Each edit is customised to your concept by
                  striking a balance between creative ingenuity and viewer
                  engagement. We make sure your music video is platform-ready,
                  reflects your creative vision, and appeals to your audience.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="text-center mt-24 mx-4 md:mx-12 lg:mx-32 xl:mx-36">
        ...
        <p className="merriHead text-[#757474] mt-4 text-sm  ">
          ...
          result satisfies your vision, we provide previews and edits. Our
          ability to work with a variety of video formats guarantees that your
          content will reach viewers without any technical issues. By staying
          current with the newest methods and platform specifications, our video
          editing guarantees that your content stays interesting and relevant.
        </p>
      </div>
        ...
        <div className="mx-8 xl:mx-60 " data-aos="zoom-in">
          <div className="text-center">
            ...
            <p className="merriHead md:mx-20 text-[#f8f7f7]   text-sm ">
              ...
              fully grasp their objectives and vision, making sure that each
              frame captures their own style. With polished, expert, and
              captivating videos, we hope to improve online visibility,
